"""Regression checks for the amber-trade-risk-forge casebook."""
...
from casebook.harness import assert_expected, amber_trade_risk_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_trade_risk_forge_summary(), assert_expected())
